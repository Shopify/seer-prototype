...
est = Estimate.create({expert: james_squirington, project: green_project, min_magnitude: 1, likely_magnitude: 6, max_magnitude: 8, min_frequency: 1.4, likely_frequency: 2.1, max_frequency: 3.1, number_of_samples: 100_000}).run_callbacks(:save)
