...
Estimate.create({expert: barbara_fu, project: orange_project, min_magnitude: 4, likely_magnitude: 4, max_magnitude: 8, min_frequency: 1.1, likely_frequency: 4.4, max_frequency: 9.9}).run_callbacks(:save)
