...
class MetricsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create metric" do
    assert_difference("Metric.count") do
      post metrics_url, params: { metric: { kind: @metric.kind, name: @metric.name, project_id: @metric.project_id, value: @metric.value } }
    end
  ...
  test "should update metric" do
    patch metric_url(@metric), params: { metric: { kind: @metric.kind, name: @metric.name, project_id: @metric.project_id, value: @metric.value } }
