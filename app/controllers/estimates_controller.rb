class EstimatesController < ApplicationController
  ...
  private
    ...
    def estimate_params
      params.require(:estimate).permit(:expert_id, :project_id, :familiarity_id, :max_magnitude, :likely_magnitude, :min_magnitude, :max_frequency, :likely_frequency, :min_frequency, :justification)
    end
end
